...
- **A player's page** shows each of their builds as a 3D card. Click one to turn and zoom it.
...
| `npm run convert`  | convert exports to GLB with baked lighting, fetch skins, write the manifest; only new or changed builds are redone                                                                            |
